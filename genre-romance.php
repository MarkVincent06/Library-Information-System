...
<head>
    ...
    <title>Books - Romance Books | Library Information System</title>
</head>
<body>
    ...
    <div class="book-container">
        ...
        <div id="book2" class="book-wrapper">
        <img class="book-cover" src="img/genre-romance/emma-book-cover.jpg" alt="An image that shows the title of the book">
        <p>Emma</p>
        <small>by <b>Jane Austen</b></small>
        </div>
        ...
        <div id="book3" class="book-wrapper">
        <img class="book-cover" src="img/genre-romance/HealingHerHeart-book-cover.jpg" alt="An image that shows the title of the book">
        <p>Healing Her Heart</p>
        <small>by <b>Laura Scott</b></small>
        </div>
    </div>
    </section>
